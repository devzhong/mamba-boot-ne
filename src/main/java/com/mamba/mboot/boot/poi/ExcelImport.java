...
public class ExcelImport {
    ...
    public void read(RowCallBack rowCallBack, CellCallBack cellCallback, InputStream is) {
        ...
        try {
            ...
            throw new NEException(NEError.READ_EXCEL_ERROR, var15);
        }
                ...
                if (row != null) {
                    if (rowCallBack != null) {
                        try {
                            ...
                            throw new NEException(NEError.READ_EXCEL_ERROR, var13);
                        }
                    }
                        ...
                        for(int cellIndex = 0; cellIndex < row.getPhysicalNumberOfCells(); ++cellIndex) {
                            ...
                            if (cell != null) {
                                try {
                                    ...
                                    throw new NEException(NEError.READ_EXCEL_ERROR, var14);
                                }
                            }
                        }
                    }

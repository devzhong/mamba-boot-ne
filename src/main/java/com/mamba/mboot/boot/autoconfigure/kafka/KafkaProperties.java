package com.mamba.mboot.boot.autoconfigure.kafka;


import com.mamba.mboot.boot.kafka.listener.AbstractListener;
...
public class KafkaProperties {
    ...
    private final Map<String, KafkaProperties.Consumer> consumers = new HashMap();
    ...
    public Map<String, KafkaProperties.Consumer> getConsumers() {
